...
$("main").addClass("main-column");
// $(".nav-container").addClass("side-nav");
// $(".main-content").addClass("main-content-column");
// $(".switch-nav").find("i").addClass("fa-th").removeClass("fa-list");
...
$(".main-content").toggleClass("main-content-column");
	...
	if ($(window).width() <= 768){
    $("main").removeClass("main-column");
    $(".nav-container").removeClass("side-nav");
    $(".main-content").removeClass("main-content-column");
	}
